...
export default function Register() {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      navigate("/login"); // redirige al login si se registró
    } catch (err) {
    ...
    <div className="register-container" style={{ display: "flex", minHeight: "100vh" }}>
      ...
      <div className="right-form-container"
        ...
        <div style={{ width: "100%", maxWidth: "350px", borderRadius: "8px", color: "rgba(2, 2, 2, 0.77)" }}>
          <h1 className="regiter" >Registro</h1>
          <form onSubmit={handleSubmit} style={{ display: "flex", flexDirection: "column", gap: "28px" }} autoComplete="off">
            ...
            />
            <button className="register-btn" type="submit" style={{ fontSize: "1.1rem", padding: "12px" }}>
              Registrarse
            </button>
          </form>
